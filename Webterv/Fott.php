...
<nav>
    <?php if (isset($_SESSION["user"])) { ?>
        ...
        <a class="kijeloles" id="aktiv" href="Fott.php">Főtt étel</a>
...
<div class="div1">
    <h2>Bárány pörkölt</h2>
    <img class="floatimg" src="images/baranyporkolt.jpg" alt="Barany porkolt">
    <table>
        <caption>Árlista</caption>
        <tr><th id="m1">Méret</th><th id="k1">Kiegészítő</th><th id="a1">Ár</th></tr>
        <tr><td headers="m1">100 Gramm</td><td headers="k1">Saláta, 0,5l üdítő</td><td headers="a1">1000 Ft</td></tr>
        <tr><td headers="m1">200 Gramm</td><td headers="k1">Saláta, 0,5l üdítő</td><td headers="a1">1600 Ft</td></tr>
        <tr><td headers="m1">300 Gramm</td><td headers="k1">Saláta, 0,5l üdítő</td><td headers="a1">2000 Ft</td></tr>
    </table>
</div>

<div class="div2">
    <h2>Babgulyás</h2>
    <img class="floatimg" src="images/babgulyas.jpg" alt="Babgulyás">
    <table>
        <caption>Árlista</caption>
        <tr><th id="m2">Méret</th><th id="k2">Kiegészítő</th><th id="a2">Ár</th></tr>
        <tr><td headers="m2">100 Gramm</td><td headers="k2">Saláta, 0,5l üdítő</td><td headers="a2">1000 Ft</td></tr>
        <tr><td headers="m2">200 Gramm</td><td headers="k2">Saláta, 0,5l üdítő</td><td headers="a2">1600 Ft</td></tr>
        <tr><td headers="m2">300 Gramm</td><td headers="k2">Saláta, 0,5l üdítő</td><td headers="a2">2000 Ft</td></tr>
    </table>
</div>

<div class="div3">
    <h2>Spagetti Bolognese</h2>
    <img class="floatimg" src="images/spagetti.jpg" alt="spagetti">
    <table>
        <caption>Árlista</caption>
        <tr><th id="m3">Méret</th><th id="k3">Kiegészítő</th><th id="a3">Ár</th></tr>
        <tr><td headers="m3">100 Gramm</td><td headers="k3">Saláta, 0,5l üdítő</td><td headers="a3">1000 Ft</td></tr>
        <tr><td headers="m3">200 Gramm</td><td headers="k3">Saláta, 0,5l üdítő</td><td headers="a3">1600 Ft</td></tr>
        <tr><td headers="m3">300 Gramm</td><td headers="k3">Saláta, 0,5l üdítő</td><td headers="a3">2000 Ft</td></tr>
    </table>
</div>

<div class="div4">
    <h2>Marha pörkölt</h2>
    <img class="floatimg" src="images/marhaporkolt.jpg" alt="marha porkolt">
    <table>
        <caption>Árlista</caption>
        <tr><th id="m4">Méret</th><th id="k4">Kiegészítő</th><th id="a4">Ár</th></tr>
        <tr><td headers="m4">100 Gramm</td><td headers="k4">Saláta, 0,5l üdítő</td><td headers="a4">1000 Ft</td></tr>
        <tr><td headers="m4">200 Gramm</td><td headers="k4">Saláta, 0,5l üdítő</td><td headers="a4">1600 Ft</td></tr>
        <tr><td headers="m4">300 Gramm</td><td headers="k4">Saláta, 0,5l üdítő</td><td headers="a4">2000 Ft</td></tr>
    </table>
</div>

<div class="div5">
    <h2>Lecsó</h2>
    <img class="floatimg" src="images/lecso.jpg" alt="Lecso">
    <table>
        <caption>Árlista</caption>
        <tr><th id="m5">Méret</th><th id="k5">Kiegészítő</th><th id="a5">Ár</th></tr>
        <tr><td headers="m5">100 Gramm</td><td headers="k5">Saláta, 0,5l üdítő</td><td headers="a5">1000 Ft</td></tr>
        <tr><td headers="m5">200 Gramm</td><td headers="k5">Saláta, 0,5l üdítő</td><td headers="a5">1600 Ft</td></tr>
        <tr><td headers="m5">300 Gramm</td><td headers="k5">Saláta, 0,5l üdítő</td><td headers="a5">2000 Ft</td></tr>
    </table>
</div>

<div class="div6">
    <h2>Töltött káposzta</h2>
    <img class="floatimg" src="images/Toltottkaposzta.jpg" alt="Toltottkaposzta">
    <table>
        <caption>Árlista</caption>
        <tr><th id="m6">Méret</th><th id="k6">Kiegészítő</th><th id="a6">Ár</th></tr>
        <tr><td headers="m6">100 Gramm</td><td headers="k6">Saláta, 0,5l üdítő</td><td headers="a6">1000 Ft</td></tr>
        <tr><td headers="m6">200 Gramm</td><td headers="k6">Saláta, 0,5l üdítő</td><td headers="a6">1600 Ft</td></tr>
        <tr><td headers="m6">300 Gramm</td><td headers="k6">Saláta, 0,5l üdítő</td><td headers="a6">2000 Ft</td></tr>
    </table>
</div>
...
<aside class="asiderendeles">
    <form method="post">
        <fieldset>
            ...
            <label for="Fottetel">Főtt étel:</label>
            <select id="Fottetel">
                <option value="Birka pörkölt">Birka pörkölt</option>
                <option value="Babgulyás">Babgulyás</option>
                <option value="Spagetti">Spagetti</option>
                <option value="Marha pörkölt">Marha pörkölt</option>
                <option value="Lecsó">Lecsó</option>
                <option value="Töltött káposzta">Töltött káposzta</option>
            </select><br/>
